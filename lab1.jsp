...
<div class="col-lg-12">
 ...
 <form action="index1.jsp">         
  <table class="table table-hover">
    ...
    <td><input type="submit" value="Book" onclick="alert('lab Name: <% lab=rs.getString(3);out.print(lab);%> Price: <% price=rs.getString(5);out.print(rs.getString(5));%> Timings:<%out.print(rs.getString(7));%>  booked');"></td>
   </tr>
  	<%} %>
    </tbody>
  </table>
